...
- Testing
  [`testthat::skip_on_os()`](https://testthat.r-lib.org/reference/skip.md)
...
(The logic of
[`skip_on_os()`](https://testthat.r-lib.org/reference/skip.md) is simple
enough that I feel confident we only need to simulate one platform.)
