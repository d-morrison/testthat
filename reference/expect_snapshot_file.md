...
[`skip()`](https://testthat.r-lib.org/reference/skip.md). To avoid files
being deleted in this case, you can call `announce_snapshot_file()`
...
path
#> [1] "/tmp/RtmpeshuIV/file1a5e39614cdf.png"
